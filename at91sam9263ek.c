 ...
 */
// Add NOR Flash and Stop Watchdog
...
void stop_watchdog(void) {
	// Stop Watchdog
	at91_sys_write(AT91_WDT + WDTC_WDMR, AT91C_WDTC_WDDIS);
}
// End
...
int board_init(void)
{
	...
	/* Start - Pull Pin */
//	at91_set_gpio_output(AT91_PIN_PE28, 0); // Power
	/* End */
