...
#else /* CFG_USE_NORFLASH */

/* bootstrap + u-boot + env + linux in nandflash */
#undef CFG_ENV_IS_IN_NAND
#undef CFG_ENV_IS_IN_SPI_FLASH
#undef CFG_ENV_IS_IN_FLASH	1
#define CFG_ENV_IS_NOWHERE
//#define CFG_ENV_IS_IN_FLASH	1
#define CFG_ENV_OFFSET		0x0
#define CFG_ENV_OFFSET_REDUND	0x80000
#define CFG_ENV_SIZE		0x10000		/* 1 sector = 64 kB */
#define CONFIG_BOOTCOMMAND	"bootm 0x10100000"
//#define CONFIG_BOOTARGS		"mem=64M console=ttyS0,115200 " \
//				"root=/dev/mtdblock2 " \
//				"ro rootfstype=cramfs quiet"
#define CONFIG_BOOTARGS		"mem=64M console=ttyS0,115200 " \
				"root=/dev/mtdblock7 " \
				"ro rootfstype=cramfs quiet"
